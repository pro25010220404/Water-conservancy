  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'AIMetrics',
        component: () => import('@/views/settings/aiHealth/metrics/index.vue'),
        meta: { title: 'AI模型健康度' },
      },
      {
        path: 'settings/ai/compare',
        name: 'AICompare',
        component: () => import('@/views/settings/aiHealth/compare/index.vue'),
        meta: { title: '模型版本对比' },
      },
      {
        path: 'settings/physics-guard',
        name: 'PhysicsGuard',
        component: () => import('@/views/settings/physicsGuard/index.vue'),
        meta: { title: '物理防护配置' },
      },
      {
        path: 'settings/physics-guard/history',
        name: 'PhysicsGuardHistory',
        component: () => import('@/views/settings/physicsGuard/history/index.vue'),
        meta: { title: '配置变更历史' },
      },
      {
        path: 'settings/gate-interlock',
        name: 'GateInterlock',
        component: () => import('@/views/settings/gateInterlock/index.vue'),
        meta: { title: '闸门互锁规则' },
      },
      {
        path: 'settings/gate-interlock/logs',
        name: 'GateInterlockLogs',
        component: () => import('@/views/settings/gateInterlock/logs/index.vue'),
        meta: { title: '互锁触发日志' },
      },
      {
        path: 'profile',
