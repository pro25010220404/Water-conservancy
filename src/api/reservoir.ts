...
const MOCK_DETAIL: Record<number, Omit<ReservoirDetail, 'equipment_count'>> = {
  ...
  2: {
    ...
    type: 'seasonal',
    type_label: '季调节',
    normal_water_level: 600,
    installed_capacity: 13860000,
    status: 'normal',
    edge_node_count: 1,
  },
  3: {
    ...
    type: 'multi_year',
    type_label: '多年调节',
    normal_water_level: 175,
    installed_capacity: 22500000,
    status: 'normal',
    edge_node_count: 1,
  },
  4: {
    ...
    type: 'daily_regulation',
    type_label: '日调节',
    normal_water_level: 190,
    installed_capacity: 500000,
    status: 'normal',
    edge_node_count: 1,
  },
}
...
export async function getReservoirDetail(
  id: number,
  equipmentCount = 0,
