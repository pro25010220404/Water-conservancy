...
.glass-panel {
  ...
  &--warning {
    ...
    background: linear-gradient(
      ...
      rgba(254, 249, 235, 0.9) 100%
    );
  }

  &--compact .glass-panel__header {
    padding: 10px 14px;
  }
  &--compact .glass-panel__body {
    padding: 12px 14px;
  }
  &--large .glass-panel__title {
    font-size: 20px;
  }
  &--large .glass-panel__body {
    padding: 18px 20px;
  }
