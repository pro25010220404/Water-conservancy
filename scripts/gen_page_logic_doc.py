...
def main():
    ...
    tbl(doc, ['状态', '方法', '路径', '触发场景'], [
        ...
        ['✓ 已有', 'POST', '/api/v1/dispatch/gate-execute', '「执行本孔」body:{equipment_id,target_opening}'],
        ['✓ 已有', 'POST', '/api/v1/dispatch/gate-execute/batch', '「提交变更」body:{items:[{equipment_id,target_opening}]}'],
